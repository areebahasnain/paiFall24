...
print(f"\nHighest Accuracy: {highest_accuracy * 100:.2f}% at seed = {best_seed_k[0]}, k = {best_seed_k[1]}")
print(f"Lowest Accuracy: {lowest_accuracy * 100:.2f}% at seed = {worst_seed_k[0]}, k = {worst_seed_k[1]}")
