...
suv = SUV("Toyota", "Fortuner", 100)
truck = Truck("Toyota", "Hilux", 150)

customer1 = Customer("Areeba Hasnain", "areeeba@example.com")
customer2 = Customer("Emman Abrar", "emman@example.com")
